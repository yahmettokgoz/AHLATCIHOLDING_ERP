...
namespace HoldingERP.DataAccess.Migrations
{
    ...
    [Migration("20250815115653_MakeTalepAciklamaNullable")]
    partial class MakeTalepAciklamaNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.Bildirim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.Departman", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.Fatura", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.Kullanici", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.LogKaydi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.Onay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.Rol", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.SatinAlmaTalebi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.SatinAlmaTalepUrunu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.Stok", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.StokHareketi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.Tedarikci", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.Teklif", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.TeklifKalem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.Urun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.Bildirim", b =>
                {
                    b.HasOne("HoldingERP.Entities.Concrete.Kullanici", "Kullanici")
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.Fatura", b =>
                {
                    b.HasOne("HoldingERP.Entities.Concrete.Kullanici", "KaydedenKullanici")
                        .WithMany("GirilenFaturalar")
                        .HasForeignKey("KaydedenKullaniciId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HoldingERP.Entities.Concrete.Teklif", "Teklif")
                        .WithOne("Fatura")
                        .HasForeignKey("HoldingERP.Entities.Concrete.Fatura", "TeklifId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.Kullanici", b =>
                {
                    b.HasOne("HoldingERP.Entities.Concrete.Kullanici", "Amir")
                        .WithMany()
                        .HasForeignKey("AmirId");

                    b.HasOne("HoldingERP.Entities.Concrete.Departman", "Departman")
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.Onay", b =>
                {
                    b.HasOne("HoldingERP.Entities.Concrete.Kullanici", "OnaylayanKullanici")
                        .WithMany("Onaylar")
                        .HasForeignKey("OnaylayanKullaniciId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HoldingERP.Entities.Concrete.SatinAlmaTalebi", "SatinAlmaTalebi")
                        .WithMany("Onaylar")
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.SatinAlmaTalebi", b =>
                {
                    b.HasOne("HoldingERP.Entities.Concrete.Kullanici", "TalepEdenKullanici")
                        .WithMany("Talepler")
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.SatinAlmaTalepUrunu", b =>
                {
                    ...
                    b.HasOne("HoldingERP.Entities.Concrete.Urun", "Urun")
                        .WithMany("TalepUrunleri")
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.StokHareketi", b =>
                {
                    b.HasOne("HoldingERP.Entities.Concrete.Fatura", "Fatura")
                        .WithMany("StokHareketleri")
                        .HasForeignKey("FaturaId");

                    b.HasOne("HoldingERP.Entities.Concrete.Kullanici", "IslemiYapanKullanici")
            ...
            modelBuilder.Entity("HoldingERP.Entities.Concrete.Teklif", b =>
                {
                    ...
                    b.HasOne("HoldingERP.Entities.Concrete.Tedarikci", "Tedarikci")
                        .WithMany("Teklifler")
                        .HasForeignKey("TedarikciId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HoldingERP.Entities.Concrete.Kullanici", "TeklifYapanKullanici")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("HoldingERP.Entities.Concrete.Rol", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("HoldingERP.Entities.Concrete.Kullanici", null)
                        .WithMany()
